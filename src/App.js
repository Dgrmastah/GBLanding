    ...
    <div className="App">
      ...
      <header className="main-header">
        ...
        <nav className="navbar">
            ...
            <li><a href="#proyectos">Proyectos Recientes</a></li>
            <li><a href="#como-trabajamos">¿Cómo trabajamos?</a></li>
            <li><a href="#cta">Listo para arrancar?</a></li>
      ...
      <main className="main-content">
        <div className="container">
          ...
          <section id="nosotros" className="section">
            <h2>Quienes somos?</h2>
            <p>
              En <strong>GB Development</strong>, somos una empresa apasionada por la tecnología y la innovación, especializada en ofrecer soluciones digitales personalizadas. Nos dedicamos al desarrollo web y la creación de plataformas digitales que permiten a nuestros clientes destacar en el mundo digital. <br /><br />
          ...
          <section id="proyectos" className="section portfolio">
            ...
            <ul>
              <li><strong>Landing Page para Tienda Online</strong> - Creación de una landing page optimizada para la conversión de usuarios en clientes, con diseño atractivo y funciones de e-commerce integradas.</li>
              <li><strong>Dashboard Personalizado</strong> - Desarrollo de un panel de administración a medida, con funcionalidades específicas para mejorar la gestión y visualización de datos en tiempo real.</li>
              <li><strong>Sitio Institucional</strong> - Diseño y desarrollo de un sitio web institucional que transmite la identidad de la marca y ofrece una experiencia de usuario fluida y profesional.</li>
            </ul>
          </section>

          {/* Como Trabajamos Section */}
          <section id="como-trabajamos" className="section process">
            ...
            <ol>
              <li><strong>Consulta Inicial</strong> - Comenzamos con una reunión para comprender tus necesidades, objetivos y visión. Es el primer paso para construir una relación sólida y asegurarnos de que estamos alineados con tus expectativas.</li>
              <li><strong>Diseño y Prototipado</strong> - En esta fase, creamos un diseño visual atractivo y funcional. Te mostramos prototipos interactivos para que puedas ver cómo se verá y funcionará tu proyecto antes de entrar en la fase de desarrollo.</li>
              <li><strong>Desarrollo y Entrega del Trabajo</strong> - Finalmente, desarrollamos el proyecto con la mejor tecnología disponible y lo entregamos funcionando perfectamente en todos los dispositivos. Nos aseguramos de que el producto final cumpla con todas tus expectativas y esté listo para ser lanzado.</li>
            </ol>
          </section>
